...
export default function Contact() {
  return (
    <Layout>
      <section className="background-dark text-foreground-light max-w-4xl mx-auto py-10 px-6">
        <h3 className="text-4xl font-bold text-primary-green text-center mb-10">Contact Me</h3>
